...
class videoCapeture: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let btn = UIButton()
        btn.addTarget(self, action: #selector(videoCapeture.startCapture), for: .touchUpInside)
        ...
        let btn2 = UIButton()
        btn2.addTarget(self, action: #selector(videoCapeture.stopCapture), for: .touchUpInside)
...
extension videoCapeture : AVCaptureVideoDataOutputSampleBufferDelegate {
